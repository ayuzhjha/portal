  ...
  return (
    <section className="min-h-screen bg-gradient-to-b from-background via-slate-900/50 to-background py-20 px-4">
      <div className="container mx-auto">
        ...
        {/* Category Row */}
        <div className="flex justify-center overflow-x-auto mb-12" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
          <div className="flex gap-4 px-2">
            {eventCategories.map((category, index) => (
              <button
                ...
                style={{ width: '140px', height: '140px', animationDelay: `${index * 0.1}s` }}
              >
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full gap-2 p-3">
                  ...
                  <h3 className="text-sm font-bold text-foreground text-center leading-tight">{category.name}</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {eventCategories
                  ...
                  ?.events.map((event, index) => (
                    ...
                    >
                      <h4 className="text-xl font-bold text-foreground group-hover:text-cyan-400 transition-colors mb-4">
                        {event.name}
                      </h4>
                      ...
                      <div className="space-y-2 text-sm mb-4">
                        ...
                        {event.mode && (
                          <p className="text-sm text-pink-400">{event.mode}</p>
                        )}
                      </div>
                      ...
                      {event.rulebookLink && (
                        <a
                          ...
                          download
                          className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-cyan-500/20 to-pink-500/20 text-cyan-400 hover:text-pink-400 border border-cyan-500/30 hover:border-pink-500/30 transition-all duration-300 text-sm font-semibold"
                        >
