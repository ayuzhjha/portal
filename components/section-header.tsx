...
export function SectionHeader({ title, subtitle, emoji }: SectionHeaderProps) {
  ...
  return (
    <div className="text-center space-y-3 mb-10 sm:mb-12 px-2">
      ...
      <p className="text-base sm:text-lg text-foreground max-w-2xl mx-auto">{subtitle}</p>
      <p className="text-xs sm:text-sm text-cyan-300 italic font-light">
        "{quote}"
      </p>
    </div>
  );
